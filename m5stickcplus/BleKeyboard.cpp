...
void BleKeyboard::onConnect(BLEServer* pServer, ble_gap_conn_desc* desc) {
  this->connected = true;
  memcpy(remoteAddress, desc->peer_ota_addr.val, sizeof(esp_bd_addr_t));
}
...
void BleKeyboard::onConnect(BLEServer* pServer, esp_ble_gatts_cb_param_t *param) {
  this->connected = true;
  memcpy(remoteAddress, param->connect.remote_bda, sizeof(esp_bd_addr_t));
...
void BleKeyboard::onDisconnect(BLEServer* pServer) {
  ...
  memset(remoteAddress, 0, sizeof(esp_bd_addr_t));
